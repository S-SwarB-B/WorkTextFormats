...
namespace TextFormats.NavigateFormats.JSON_Format
{
    public class JSONTextFormat
    {
        public Person[]? JsonMethodReading(string path) //CSV метод считывания файла
        {
        ...
        public int JsonMethodWriting(string path, Person person) //Общий метод записи в файл
        {
            try //Обработка исключений
            {
