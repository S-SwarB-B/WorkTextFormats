...
namespace TextFormats.NavigateFormats.XML_Format
{
    public class XMLTextFormat
    {
        public Person[]? XMLMethodReading(string path) //CSV метод считывания файла
        {
        ...
        public int XMLMethodWriting(string path, Person person) //Общий метод записи в файл
        {
            try //Обработка исключений
            {
