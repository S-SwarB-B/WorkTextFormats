...
namespace TextFormats.NavigateFormats.YAML_Format
{
    public
        class YAMLTextFormat
    {
        public Person[]? YamlMethodReading(string path) //CSV метод считывания файла
        {
        ...
        public int YamlMethodWriting(string path, Person person) //Общий метод записи в файл
        {
            try //Обработка исключений
            {
